...
class GManWebBuilderAgent:
    def __init__(self):
        # Direct Endpoint Mapping Path to match custom worker string outputs
        self.gateway_url = "https://workers.dev"
        self.output_dir = os.path.abspath("generated_sites")
        if not os.path.exists(self.output_dir):
            os.makedirs(self.output_dir)
        print(f"[OMNI-AGENT PRODUCTION ONLINE]: Direct REST communications pipe initialized.")
